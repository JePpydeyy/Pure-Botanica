...
"[project]/src/app/admin/order/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function OrderPage() {
    ...
    // Reverse map for updating (Vietnamese to English)
    const reverseStatusMap = Object.fromEntries(Object.entries(statusMap).map(([key, value])=>[
            value,
            key
        ]));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchOrders = async ()=>{
            try {
                ...
                console.log('Dữ liệu đơn hàng:', data); // Gỡ lỗi
                setOrders(data);
            } catch (error) {
                console.error('Lỗi khi tải đơn hàng:', error);
                setError('Không thể tải danh sách đơn hàng');
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Không thể tải danh sách đơn hàng');
            }
        };
        fetchOrders();
    }, []);
    ...
    const updateStatus = async (orderId, newStatus)=>{
        ...
        if (!newStatus || !Object.keys(statusMap).includes(newStatus)) {
            setError('Trạng thái không hợp lệ');
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Trạng thái không hợp lệ');
            return;
        }
        const oldOrders = [
            ...orders
        ...
        try {
            const response = await fetch(`https://api-zeal.onrender.com/api/orders/status/${orderId}`, {
                method: 'PUT',
                headers: {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorData.error || `Lỗi HTTP ${response.status}: Không thể cập nhật trạng thái`);
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Cập nhật trạng thái thành công');
        } catch (error) {
            console.error('Lỗi khi cập nhật trạng thái:', error);
            setOrders(oldOrders); // Rollback
            setError(error.message || 'Không thể cập nhật trạng thái');
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(error.message || 'Không thể cập nhật trạng thái');
        }
    };
    // Format date to DD-MM-YYYY
    const formatDate = (dateString)=>{
        const date = new Date(dateString);
        return isNaN(date.getTime()) ? 'Ngày không hợp lệ' : `${date.getDate().toString().padStart(2, '0')}-${(date.getMonth() + 1).toString().padStart(2, '0')}-${date.getFullYear()}`;
    };
    if (error) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/src/app/admin/order/page.tsx",
        lineNumber: 97,
        columnNumber: 21
    }, this);
    if (!orders.length) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: "Đang tải..."
    }, void 0, false, {
        fileName: "[project]/src/app/admin/order/page.tsx",
        lineNumber: 98,
                            ...
                            children: orders.map((order, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                href: `/orderdetail/${order._id}`,
                                                children: order.address || 'Chưa có địa chỉ'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/admin/order/page.tsx",
                                                lineNumber: 127,
                                                columnNumber: 19
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                value: statusMap[order.status] || 'Không xác định',
                                                onChange: (e)=>{
                                                    console.log('Giá trị chọn:', e.target.value); // Gỡ lỗi
                                                    const newStatus = reverseStatusMap[e.target.value];
                                                    if (newStatus && newStatus !== order.status) {
                                                        if (newStatus === 'cancelled' && !confirm('Bạn có chắc muốn hủy đơn hàng này?')) {
                                                            return;
                                                        }
                                                        updateStatus(order._id, newStatus);
                                                    } else if (!newStatus) {
                                                        console.error('Trạng thái không hợp lệ:', e.target.value);
                                                        setError('Trạng thái không hợp lệ');
                                                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Trạng thái không hợp lệ');
                                                    }
                                                },
                                                className: order.status === 'shipped' || order.status === 'pending' ? 'table-status-fail' : order.status === 'cancelled' ? 'table-status-cancelled' : order.status === 'delivered' ? 'table-status-success' : 'table-status-unknown',
                                                disabled: order.status === 'cancelled',
                                                children: [
                                                    Object.values(statusMap).map((vnStatus)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                            value: vnStatus,
                                                            children: vnStatus
                                                        }, vnStatus, false, {
                                                            fileName: "[project]/src/app/admin/order/page.tsx",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82368e4c._.js.map