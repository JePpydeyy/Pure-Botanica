(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_c6e7e3eb._.js", {

"[project]/src/app/admin/add_product/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function AddProduct() {
    ...
    const fetchCategories = async ()=>{
        try {
            const res = await fetch(`https://api-zeal.onrender.com/api/categories?t=${Date.now()}`, {
                cache: "no-store"
            });
            const data = await res.json();
            const categoryArray = Array.isArray(data) ? data : data.categories || [];
            if (!Array.isArray(categoryArray)) throw new Error("Dữ liệu danh mục không hợp lệ");
    ...
    const validateForm = ()=>{
        ...
        if (formData.price < 0) return "Giá sản phẩm không hợp lệ";
        if (formData.discountPrice < 0) return "Giảm giá sản phẩm không hợp lệ";
        if (formData.stock < 0) return "Số lượng không hợp lệ";
        if (!formData.category._id) return "Vui lòng chọn danh mục";
        if (formData.images.length === 0) return "Sản phẩm phải có ít nhất một ảnh";
        if (formData.images.length > 5) return "Chỉ được chọn tối đa 5 ảnh";
        return null;
    };
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            data.append("category_id", formData.category._id);
            ...
            [
                ...
                formData[key].forEach((item)=>{
                    if (item.trim()) {
                        data.append(`${key}[]`, item.trim());
                    }
                });
            });
            formData.images.forEach((file)=>{
                if (file.size > 5 * 1024 * 1024) throw new Error(`Ảnh ${file.name} vượt quá giới hạn 5MB`);
                if (!file.type.match(/image\/(jpg|jpeg|png|gif|webp)/)) throw new Error(`Ảnh ${file.name} không đúng định dạng`);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                type: "submit",
                                disabled: loading,
                                children: loading ? "Đang thêm..." : "Thêm sản phẩm"
                            }, void 0, false, {
                                fileName: "[project]/src/app/admin/add_product/page.tsx",
                                lineNumber: 243,
                                columnNumber: 11
...
_s(AddProduct, "6aAg32WS6BJ26ktz7KAOFqJniR8=", false, function() {
    return [
...
//# sourceMappingURL=_c6e7e3eb._.js.map